...
CARD = '''<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="180" viewBox="0 0 1200 180" role="img" aria-labelledby="title desc">
  <title id="title">Worker Time List Generator product progress</title>
  ...
  <text x="50" y="82" fill="#F4FAFF" font-family="Segoe UI,Arial,sans-serif" font-size="29" font-weight="800">WORKER TIME LIST GENERATOR</text>
...
MINI = '''<svg xmlns="http://www.w3.org/2000/svg" width="900" height="72" viewBox="0 0 900 72" role="img" aria-labelledby="title desc">
  <title id="title">Worker Time List Generator roadmap progress</title>
  <desc id="desc">Roadmap progress is N/A because no canonical measurable roadmap exists.</desc>
